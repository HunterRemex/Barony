...
//--PLAYER SPAWN POINT--
	...
	bool isMobile(); // teleport entity to fixed position with appropriate sounds, for actTeleporter.
	...
	static bool isPlayerHeadSprite(const int sprite); // determines if model of entity is a human head.
